...
{
    public static final File CONFIG_FILE = new File(KoolChatFilter.getInstance().getDataFolder(), "config.yml");
    ...
    {
        return KoolChatFilter.getInstance().getResource("config.yml");
    }
